...
//    settings.setProperty("crowd.password", "secure");
    ...
    final RestCrowdClient restCrowdClient = new RestCrowdClient(clientProps);

    
    final User user = restCrowdClient.getUser("qxo");

    
 

 System.out.println("user:"+restCrowdClient.getCookieConfiguration().getName());
